...
class PaedetricianScreen extends StatefulWidget {
  @override
  _PaedetricianScrenState createState() => _PaedetricianScrenState();
}

class _PaedetricianScrenState extends State<PaedetricianScreen> {
  int checkedIndex1 = -1;

  Widget buildPaedetricianDocCard(int index) {
            ...
            children: [
              GridView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return buildPaedetricianDocCard(index);
                  }),
            ],
          ),
        ),
