...
class OncologistScreen extends StatefulWidget {
  @override
  _OncologistScreenState createState() => _OncologistScreenState();
}

class _OncologistScreenState extends State<OncologistScreen> {
  int checkedIndex1 = -1;

  Widget buildOncologistDocCard(int index) {
            ...
            children: [
              GridView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return buildOncologistDocCard(index);
                  }),
            ],
          ),
        ),
